...
void FShaderCompileUtilities::ApplyFetchEnvironment(FShaderMaterialPropertyDefines& SrcDefines, FShaderCompilerEnvironment& OutEnvironment)
{
	...
	FETCH_COMPILE_INT(DECALBLENDMODEID_VOLUMETRIC);
	FETCH_COMPILE_INT(DECALBLENDMODEID_STAIN);
	FETCH_COMPILE_INT(DECALBLENDMODEID_NORMAL);
	FETCH_COMPILE_INT(DECALBLENDMODEID_EMISSIVE);
	FETCH_COMPILE_INT(DECALBLENDMODEID_TRANSLUCENT);
	FETCH_COMPILE_INT(DECALBLENDMODEID_AO);
	FETCH_COMPILE_INT(DECALBLENDMODEID_ALPHACOMPOSITE);

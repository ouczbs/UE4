...
namespace Chaos
{
	namespace DebugDraw
	{
		...
		void DrawShapesImpl(const TGeometryParticleHandle<FReal, 3>* Particle, const FRigidTransform3& ShapeTransform, const FImplicitObject* Shape, const FReal Margin, const FColor& Color, const FChaosDebugDrawSettings& Settings);
			...
			if (Shape->HasStructureData())
			{
				...
				for (int32 PlaneIndex = 0; PlaneIndex < Shape->GetFaces().Num(); ++PlaneIndex)
				{
					...
					for (int32 PlaneVertexIndex = 0; PlaneVertexIndex < PlaneVerticesNum; ++PlaneVertexIndex)
					{
						...
						// Outer shape
						FDebugDrawQueue::GetInstance().DrawDebugLine(OuterP0, OuterP1, Color, false, -1.f, Settings.DrawPriority, Settings.ShapeThicknesScale * Settings.LineThickness);
		...
		void DrawShapesLevelSetImpl(const TGeometryParticleHandle<FReal, 3>* Particle, const FRigidTransform3& ShapeTransform, const TLevelSet<FReal, 3>* Shape, const FColor& Color, const FChaosDebugDrawSettings& Settings)
		{
		...
		void DrawShapesScaledImpl(const TGeometryParticleHandle<FReal, 3>* Particle, const FRigidTransform3& ShapeTransform, const FImplicitObject* Shape, const FReal Margin, const FColor& Color, const FChaosDebugDrawSettings& Settings)
		{
		...
		void DrawShapesInstancedImpl(const TGeometryParticleHandle<FReal, 3>* Particle, const FRigidTransform3& ShapeTransform, const FImplicitObject* Shape, const FReal Margin, const FColor& Color, const FChaosDebugDrawSettings& Settings)
		{
			const EImplicitObjectType PackedType = Shape->GetType();
			const EImplicitObjectType InnerType = GetInnerType(PackedType);
		...
		void DrawShapesImpl(const TGeometryParticleHandle<FReal, 3>* Particle, const FRigidTransform3& ShapeTransform, const FImplicitObject* Shape, const FReal Margin, const FColor& Color, const FChaosDebugDrawSettings& Settings)
		{
			...
			case ImplicitObjectType::LevelSet:
			{
				const TLevelSet<FReal, 3>* LevelSet = Shape->template GetObject<TLevelSet<FReal, 3>>();

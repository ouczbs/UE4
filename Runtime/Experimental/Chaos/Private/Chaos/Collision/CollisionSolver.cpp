...
namespace Chaos
{
	namespace Collisions
	{
		...
		float Chaos_Manifold_Apply_MinStiffness = 0.25f;
		float Chaos_Manifold_Apply_MaxStiffness = 1.0f;
		...
		float Chaos_Manifold_PushOut_MinStiffness = 0.25f;
		float Chaos_Manifold_PushOut_MaxStiffness = 0.5f;
		...
		float Chaos_Manifold_Apply_ImpulseTolerance = 1.e-4f;

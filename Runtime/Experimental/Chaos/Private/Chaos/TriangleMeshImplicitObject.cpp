...
void FTriangleMeshImplicitObject::VisitTriangles(const FAABB3& QueryBounds, const TFunction<void(const TTriangle<FReal>& Triangle)>& Visitor) const
{
	const TArray<int32> PotentialIntersections = BVH.FindAllIntersections(QueryBounds);
